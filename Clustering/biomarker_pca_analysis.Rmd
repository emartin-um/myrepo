...
```{r load-data}
# Read the data
data <- read.csv("meta_plus_race_dx.csv", stringsAsFactors = FALSE)
...
create_ab42_ab40_ratio <- function(input_file = "meta_plus_race_dx.csv") {
...
data <- create_ab42_ab40_ratio("meta_plus_race_dx.csv")
```
